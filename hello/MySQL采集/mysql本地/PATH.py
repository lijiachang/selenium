...
def outputs(sql):
    ...
    if "ERROR" or "-bash: mysql:" in stderr:
...
if __name__ == '__main__':
    print(separator.join([mpoint, ckbp, "ACM-00-03-06-00-03", outputs("select @@basedir as basePath from dual;")]))  # 安装目录
