...
######## monitor keys list#####################
keyl = ['Open_tables', 'Threads_connected', 'Open_files', 'Innodb_buffer_pool_pages_free',
        'Innodb_buffer_pool_pages_dirty', 'Innodb_buffer_pool_pages_total', 'Qcache_free_memory', 'Questions']
