...
################# 配置区 ##############################################################################################
domain = 'www.yueshengjia.com'  # 网站地址 www.xxx.com
domain_index = 'http://www.yueshengjia.com/admin/?index.html'  # 管理后台的页面URL
username = 'ijianghu'  # 后台管理用户名
password = 'ukxmVgZ56vLkWsC'  # 后台管理密码
...
class ArticleForm:
    ...
    def init_city_id_map(self):
        """获取发布页的 城市和id 映射关系
        http://www.yueshengjia.com/admin/?block/item-push-article-151.html&MINI=load
    ...
    def post_article(self, image_file_path):
        """发布文章内容
        请求URL: http://www.yueshengjia.com/admin/?article/article-create.html
        ...
        Host: www.yueshengjia.com
        Origin: http://www.yueshengjia.com
        Referer: http://www.yueshengjia.com/admin/?article/article-create.html
        Upgrade-Insecure-Requests: 1
        User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4621.0 Safari/537.36
