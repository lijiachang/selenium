...
################# 配置区 ##############################################################################################
domain = 'yiyou.yueshengjia.com'  # 网站地址 www.xxx.com
domain_index = 'http://yiyou.yueshengjia.com/login.php?s=Admin/login'  # 管理后台的页面URL
...
Host: yiyou.yueshengjia.com
Origin: http://yiyou.yueshengjia.com
Referer: http://yiyou.yueshengjia.com/login.php?m=admin&c=Article&a=add&typeid=1&gourl=http%3A%2F%2Fyiyou.yueshengjia.com%2Flogin.php%3Fm%3Dadmin%26c%3DArchives%26a%3Dindex_archives%26typeid%3D1%26lang%3Dcn&lang=cn
...
class ArticleForm:
    ...
    def post_image(self, image_path):
        """上传略缩图
        请求 URL: http://yiyou.yueshengjia.com/login.php?m=admin&c=Ueditor&a=imageUp&savepath=allimg&pictitle=banner&dir=images&is_water=1&lang=cn
    ...
    def post_article(self, image_url):
        """发布文章内容
        请求URL: http://yiyou.yueshengjia.com/login.php?m=admin&c=Article&a=add&lang=cn
