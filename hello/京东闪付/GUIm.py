...
PAGE20_30_5 = r"https://pa.jd.com/prize/center/h5/draw?entranceKey=a6a8a6d04a04d58852d71e4a2477642f"  # 美团外卖 30-5
...
root.title("京东闪付5元 V1.8.5 美团30-5  作者QQ944581577")
    ...
    while True:
        ...
        if page == PAGE20_30_5:
            if u"今日已领取" in result or "prizeDesc" in result:
                text.insert("end", "【20:00】美团30-5 领取成功！\n")
                break
            elif u"登录后才可以领奖" in result:
                break
...
def update_page():
    ...
    if now == "20.00":
        ...
        for one_cookie in cookie_list_dict:
            ...
            t2 = threading.Thread(target=judge_result, args=(PAGE20_30_5, one_cookie,))
            threads.append(t)
            threads.append(t2)
        for thread in threads:
            thread.start()
