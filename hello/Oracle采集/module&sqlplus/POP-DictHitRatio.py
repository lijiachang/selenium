...
if __name__ == "__main__":
    sqlComm = """select round(100 * (1 - sum(getmisses) / sum(gets)), 2) rowcache_hitratio
  from v\$rowcache;"""  # ����$ ��Ҫת��
    if model == 'sqlplus':
    ...
    results = list()
    results.append(separator.join([mpoint, ckbp, "PM-ORACLE-PERFORMANCE-DictHitRatio", str(result[0].get("ROWCACHE_HITRATIO"))]))
