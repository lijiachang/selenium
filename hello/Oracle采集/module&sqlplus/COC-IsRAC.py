...
if __name__ == "__main__":
    sqlComm = """select value from v\$option a where a.PARAMETER='Real Application Clusters';"""  # ����$ ��Ҫת��
    if model == 'sqlplus':
    ...
    results = list()
    results.append(separator.join([mpoint, ckbp, "CM-ORACLE-CONFIG-IsRAC", result[0].get("VALUE")]))  
