...
##    print gStrConnection.split('@')[1].replace('/','-')+'||""||ACM-00-03-01-00-45||'+str(i.values()[1])
mpoint = "-".join([hostip, port, ins])
ckbp = ""
separator = "||"
wrap = "\n"
...
results.append(separator.join([mpoint, ckbp, "ACM-00-03-01-00-45", queryresult[0].get("ROUND(VALUE/1024/1024)")]))
