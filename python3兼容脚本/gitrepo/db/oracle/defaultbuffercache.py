...
##    print gStrConnection.split('@')[1].replace('/','-')+'||""||ACM-00-03-01-00-46||'+str(i.values()[0])
mpoint = "-".join([hostip, port, ins])
ckbp = ""
separator = "||"
wrap = "\n"
...
results.append(separator.join([mpoint, ckbp, "ACM-00-03-01-00-46", queryresult[0].get("CUR_SIZE_M")]))
