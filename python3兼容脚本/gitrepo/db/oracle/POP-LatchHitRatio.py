...
if __name__ == "__main__":
    sqlComm = """select round((1 - sum(misses + immediate_misses) / sum(gets + immediate_gets)) * 100,  2) "Latch Hit Ratio"  from v\$latch;"""  # ����$ ��Ҫת��
    ...
    results = list()
    results.append(separator.join([mpoint, ckbp, "PM-ORACLE-PERFORMANCE-LatchHitRatio", result[0].get("Latch Hit Ratio")]))  
