...
for j in queryversion:
    ...
    # print ver
if ver == "11.2.0.1.0":
    sqlComm = "select component,current_size/1024/1024 cur_size_M  from  v\$memory_dynamic_components where component = 'java pool';"
    # print "if"
else:
    sqlComm = "select component, current_size / 1024 / 1024 cur_size_M from v\$sga_dynamic_components where component = 'java pool';"
    # print "else"
...
##    print gStrConnection.split('@')[1].replace('/','-')+'||""||ACM-00-03-01-00-51||'+str(i.values()[0])
...
results.append(separator.join([mpoint, ckbp, "ACM-00-03-01-00-51", queryresult[0].get("CUR_SIZE_M")]))
