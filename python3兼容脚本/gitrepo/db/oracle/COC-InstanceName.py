...
if __name__ == "__main__":
    sqlComm = """select instance_name from v\$instance;"""  # ����$ ��Ҫת��
    ...
    results = list()
    results.append(separator.join([mpoint, ckbp, "CM-ORACLE-CONFIG-InstanceName", result[0].get("INSTANCE_NAME")]))  #InstanceName
