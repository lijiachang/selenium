...
#    print gStrConnection.split('@')[1].replace('/','-')+'||""||AFM-40-12-001-01||'+str(i.values()[0])
...
results.append(separator.join([mpoint, ckbp, "AFM-00-03-01-00-12", queryresult[0].get("RATIO")]))
